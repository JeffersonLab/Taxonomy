        ...
        $(function () {
            ...
            $('.sortable').sortable({
                ...
                update: function (event, ui) {
                    atlis.reorderTerms($(event.target).attr('id'), $(event.target).sortable("toArray"))
                }
            });
            ...
            $('.btn-edit').on('click', atlis.editItemDialog);
            $('.btn-add').on('click', atlis.editItemDialog);
            $('.btn-users').on('click', atlis.editUsersDialog);
            $('.btn-delete').on('click', atlis.deleteItemDialog);
